        ...
        <div className='col-sm-6 col-md-5 col-lg-6 col-xl-6'>
          <div className='widget-item'>
            <div className='about-widget'>
              <Logo classOption='footer-logo' image='/img/logo-dark.png' />
              <ul className='widget-contact-info'>
                ...
                <li className='info-phone'>
                  ...
                  <a
                    href={`tel://${appSettingsData.hotline.replaceAll(
                      '.',
                      ''
                    )}`}
                  >
        ...
        <div className='row text-center'>
          <div className='col-sm-12'>
            <div className='widget-copyright'>
              <p>
                &copy; 2021{' '}
                <span className='text-uppercase'>AI 4 Smart Healthcare</span>.
                Bản quyền <i className='icofont-heart-alt' /> của{' '}
